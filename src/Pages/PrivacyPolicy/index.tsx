...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    ...
    const responseArray = (rawData as any)?.privacy_policy_data;
  ...
  useEffect(() => {
    if (error) { setContent(""); setSavedContent(""); setIsEditing(true); }
  }, [error]);

  const handleEdit = () => { setIsEditing(true); setContent(savedContent); };
